...
class ED(nn.Module):
    ...
    def __init__(self, encoder0, encoder1, encoder2, decoder1, decoder2):
        super().__init__()
    ...
    def forward(self, input, input_decoder, wrf):
        # input_low = input[:, :, :, ::2, ::2]
        state0 = self.encoder0(wrf)
        ...
        # state = list(state2)
        # output_low = output_low.view(-1, 8, 120, 152)
