...
convgru_encoder_params = [
    ...
    [
        ...
        CGRU_cell(shape=(120, 152), input_channels=64, filter_size=5, num_features=96),
        CGRU_cell(shape=(60, 76), input_channels=96, filter_size=5, num_features=96)
    ]
]
...
convgru_decoder_params = [
    ...
    [
        CGRU_cell(shape=(60, 76), input_channels=96, filter_size=5, num_features=96),
        CGRU_cell(shape=(120, 152), input_channels=96, filter_size=5, num_features=96),
        CGRU_cell(shape=(240, 304), input_channels=96, filter_size=5, num_features=64),
    ]
]
