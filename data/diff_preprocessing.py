...
# diff = torch.load(r'C:\Users\lihaobo\Downloads\data\data_no2\diff.pt')
...
# torch.save(distribution, 'diff_after_cor.pt')

distribution = torch.load(r'C:\Users\lihaobo\Downloads\data\data_no2\diff_after_cor.pt')
lng_lat = np.load(r'C:\Users\lihaobo\Downloads\data\data_no2\lnglat-no-receptors.npz')
lon = lng_lat['lngs'][:73200].reshape([240, 305])[:, :304]
lat = lng_lat['lats'][:73200].reshape([240, 305])[:, :304]
fig = plt.figure()
